...
if __name__ == '__main__':
    ...
    # app.run(debug=True, host="0.0.0.0", port=6000, ssl_context=(cert_path, key_path))
    
    app.run(debug=True,host="0.0.0.0", port=6000)  # Set debug to False in a production environment
